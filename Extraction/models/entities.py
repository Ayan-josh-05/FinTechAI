...
class Case(BaseModel):
    ...
    filing_year: Optional[int] = Field(None, description="Year in which the case was filed.")
    ...
    in_favour_of: Optional[bool] = Field(None, description="True if decided in favour of petitioner, False if respondent, null if not decided.")
    alleged_amount: Optional[float] = Field(None, description="The principal amount involved in the dispute (in INR).")
