...
class Judge(BaseModel):
    ...
    # experience_years: Optional[int] = Field(None, description="Total years of judicial experience.")
    # specialization: Optional[str] = Field(None, description="Primary legal area of expertise.")
    # secondary_specialization: Optional[str] = Field(None, description="Secondary area of expertise.")
    # contact_info: Optional[str] = Field(None, description="Official contact details.")
    # appointment_date: Optional[str] = Field(None, description="Date when appointed to current post.")
...
class Lawyer(BaseModel):
    ...
    # experience_years: Optional[int] = Field(None, description="Total years of practice.")
    # years_of_practice: Optional[int] = Field(None, description="Number of years practicing in current court.")
...
class Case(BaseModel):
    ...
    alleged_amount: Optional[float] = Field(None, description="The principal amount involved in the dispute.")
    # risk_score: Optional[float] = Field(None, description="Calculated probability of outcome or complexity.")
    court_info: Optional[str] = Field(None, description="Reference to the court presiding over this case.")
...
class Court(BaseModel):
    ...
    hierarchy_level: Optional[int] = Field(None, description="Level in the judicial hierarchy.")
...
class Act(BaseModel):
    ...
    year: Optional[int] = Field(None, description="The year the Act was passed.")
...
class Section(BaseModel):
    ...
    bailable: Optional[bool] = Field(None, description="Whether the offense is bailable.")
...
class CaseHearing(BaseModel):
    ...
    remarks: Optional[str] = Field(None, description="Judge's or clerk's notes from the hearing.")
