...
This project includes a multi-stage Dockerfile for both development

**Build and run:**

```bash
docker build -t my-vite-app-dev .
docker run -p 3000:3000 my-vite-app-dev
```

**Notes:**

- The Dockerfile copies both the build output (`dist/`) and public assets to the Nginx web root.
